...
METERS_MODEL.load_weights("../meters_model/cp.ckpt")

# get the embeddings model
BASE_MODEL = create_model_v1()
BASE_MODEL.load_weights("../embeddings_extractor_model/cp.ckpt")
...
BAITS_EMBEDDINGS = load_from_disk("../baits_embeddings")


import tkseem as tk

ERA_MODEL = create_era_theme_model()
ERA_MODEL.load_weights("../era_classification_model/cp.ckpt")

ERA_TOKENIZER = tk.SentencePieceTokenizer()
ERA_TOKENIZER.load_model("../era_classification_model/vocab.model")


THEME_MODEL = create_era_theme_model()
THEME_MODEL.load_weights("../theme_classification_model/cp.ckpt")

THEME_TOKENIZER = tk.SentencePieceTokenizer()
THEME_TOKENIZER.load_model("../theme_classification_model/vocab.model")
